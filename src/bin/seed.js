...
//importar variBles de entorno para hacer conexion con datos
//requiero a mi modulo de dotenv y mi .config
...
//FUNCION QUE VA A POBLAR LA DATA BASE
//POPULATE DB
const generateAnimes = async () => {
  await Anime.create(animes);
  console.log("base de datos pobladas con animes chinos kawaiis");

  //cerramos la conexion con la DB
  //Riesgos: Rendimiento, Si tienes una base de paga va a salir mas caro
